    ...
    <div class="stats-grid-2" style="margin-bottom:30px;">
        ...
        <div class="mb-3">
            <input type="text" id="requestSearch" class="form-control"
                placeholder="🔍 Search by district, type or severity..."
...
<div id="requestModal" style="display:none;position:fixed;top:0;left:0;width:100%;height:100%;background:rgba(0,0,0,0.7);z-index:9999;justify-content:center;align-items:center;">
    <div style="background:#0f172a;border:1px solid rgba(255,255,255,0.1);border-radius:20px;padding:40px;width:560px;max-width:90%;box-shadow:0 0 40px rgba(0,0,0,0.5);position:relative;max-height:90vh;overflow-y:auto;">

        <button onclick="closeRequestModal()" style="position:absolute;top:15px;right:20px;background:transparent;border:none;color:#94a3b8;font-size:20px;cursor:pointer;">✕</button>

        <h3 style="color:#f97316;margin-bottom:20px;font-size:20px;">📋 Request Details</h3>

        <div id="requestModalContent" style="display:grid;grid-template-columns:1fr 1fr;gap:15px;margin-bottom:25px;"></div>

        <!-- Description -->
        <div style="margin-bottom:25px;">
            <div style="color:#94a3b8;font-size:11px;text-transform:uppercase;letter-spacing:1px;margin-bottom:6px;">Description / Special Requirements</div>
            <div id="requestDescription" style="color:white;background:rgba(255,255,255,0.05);padding:12px;border-radius:8px;font-size:14px;line-height:1.6;"></div>
        </div>

        <!-- Action Buttons -->
        <div style="display:flex;justify-content:space-between;align-items:center;gap:10px;">
            <button onclick="closeRequestModal()" class="btn-back-blue" style="cursor:pointer;border:none;">Cancel</button>
            <div style="display:flex;gap:10px;">
                <a id="rejectBtn" href="#"
                    onclick="return confirmAction('Reject this relief request?')"
                ...
                <a id="acceptBtn" href="#"
                    onclick="return confirmAction('Accept this relief request?')"
