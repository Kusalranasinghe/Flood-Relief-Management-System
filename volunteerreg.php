...
<body>
    ...
    <div class="request-container" style="padding-top:120px;">
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST" class="request-card">
            ...
            <p style="color:#94a3b8;font-size:13px;text-align:center;margin-bottom:20px;">Register to help flood affected communities</p>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <div style="position:relative;">
                    <input type="text" name="nic" id="nic_input" class="form-control" placeholder="e.g. 123456789V or 200012345678">
            ...
            <div class="mb-3">
                ...
                <div style="position:relative;">
                    <div class="input-group">
                        ...
                        <input type="text" name="telephone" id="reg_phone_input" class="form-control" placeholder="7XXXXXXXX" maxlength="9">
                    </div>
